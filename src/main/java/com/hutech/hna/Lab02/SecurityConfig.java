package com.hutech.hna.Lab02;

import com.hutech.hna.Lab02.service.UserService;
...
public class    SecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
        return (UserDetailsService) new UserService(); // Cung cấp dịch vụ xử lý chi tiết người dùng.
    }
    @Bean
